'''
This is the main code of the semi-supervised speaker recognition with fixmatch, to define the parameters and build the construction
'''

import argparse, glob, warnings, time, sys, yaml
from tools import *
from dataLoader1 import train_loader
from semi_model.fixmatch import ECAPAModel
...
if __name__ == "__main__":
	parser = argparse.ArgumentParser(description="Semi-supervised speaker recognition with Fixmatch")
	## Training Settings
	...
	parser.add_argument('--lb_samples_per_class', type=float, default=4, help='Number of speaker labels per class')
	## Command
