'''
This is the main code of the semi-supervised speaker recognition with flexmatch, to define the parameters and build the construction
'''

import argparse, glob, warnings, time, sys, yaml
from tools import *
from dataLoader1 import train_loader
from semi_model.flexmatch import ECAPAModel
...
def main_worker(args):
	...
	while (1):
		...
		loss, lr, acc = s.train_network(putoff=args.putoff, epoch=epoch, loader1=Lb_trainloader, loader2=Ulb_trainloader)
...
if __name__ == "__main__":
	parser = argparse.ArgumentParser(description="Semi-supervised speaker recognition with Flexmatch")
	## Training Settings
	...
	parser.add_argument("--putoff", type=float, default=0.000351, help='Confidence threshold')
	...
	parser.add_argument('--lb_samples_per_class', type=float, default=20, help='Number of speaker labels per class')
	## Command
