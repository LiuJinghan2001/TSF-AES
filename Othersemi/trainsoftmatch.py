'''
This is the main code of the semi-supervised speaker recognition with softmatch, to define the parameters and build the construction
'''
...
if __name__ == "__main__":
	parser = argparse.ArgumentParser(description="Semi-supervised speaker recognition with Softmatch")
	## Training Settings
	...
	parser.add_argument("--putoff", type=float, default=0.9, help='Confidence threshold')
