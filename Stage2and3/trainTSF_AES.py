...
from semi_model.TSF_AES import ECAPAModel
...
if __name__ == "__main__":
	...
	parser.add_argument('--max_epochS3', type=int, default=30, help='Maximum number of epochs1')
	parser.add_argument('--batch_size_s2', type=int, default=200, help='Batch size')
	parser.add_argument('--batch_size_s3', type=int, default=150, help='Batch size')
	...
	parser.add_argument("--putoff", type=float, default=1, help='Learning rate decay every [test_step] epochs')
	...
	parser.add_argument('--lb_samples_per_class', type=float, default=10, help='Number of speakers')
	## Command
