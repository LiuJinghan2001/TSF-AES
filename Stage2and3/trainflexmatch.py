...
if __name__ == "__main__":
	...
	parser.add_argument("--putoff", type=float, default=0.000351, help='Learning rate decay every [test_step] epochs')
	...
	parser.add_argument('--lb_samples_per_class', type=float, default=20, help='Number of speakers')
	## Command
